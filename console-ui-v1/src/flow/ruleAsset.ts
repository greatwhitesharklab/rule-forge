...
export interface FlowElement {
  ...
  implementation?: string; // serviceTask/startEvent/endEvent
  sourceRef?: string; // sequenceFlow
  targetRef?: string; // sequenceFlow
  conditionExpression?: string; // sequenceFlow (gateway 出边 CEL)
  defaultFlow?: string; // exclusiveGateway
}
