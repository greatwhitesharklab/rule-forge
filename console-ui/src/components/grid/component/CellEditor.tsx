        ...
        switch (editorType) {
            case "select": {
                ...
                return (<select ref={this.inputRef as React.RefObject<HTMLSelectElement>} style={styleObj} onBlur={this.blur.bind(this)}
                    className="grid-cell-input" defaultValue={currentValue}>
            ...
            case "boolean":
                return (
                    <select ref={this.inputRef as React.RefObject<HTMLSelectElement>} onBlur={this.blur.bind(this)} className="grid-cell-input"
