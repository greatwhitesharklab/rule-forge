...
import {type V1Node, type RuleSetNode, type Rule, type Action, type ActionType, type Arg,
    type DecisionTableNode, type ScoreCardNode, type Card,
    type DecisionNode, type StartNode} from './ruleAsset';
import ConditionEditor from './ConditionEditor';

const {Text} = Typography;
const ACTION_TYPES: ActionType[] = ['SET_VARIABLE', 'ADD_SCORE', 'SET_DECISION', 'REJECT', 'FLAG', 'INVOKE'];
...
function InvokeActionFields({action, onChange}: {action: Action; onChange: (patch: Partial<Action>) => void}) {
