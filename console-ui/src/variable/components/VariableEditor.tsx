...
class VariableEditor extends Component<VariableEditorProps> {
    masterData: VariableCategory | null = null;
                ...
                <Splitter orientation='vertical' position='50%'>
                    <div style={{padding: '0px'}}>
                        ...
                        <Grid headers={masterGridHeaders} dispatch={dispatch} rows={masterData}
                              operationConfig={masterGridOperationCol} rowClick={(rowData: VariableCategory) => {
...
function select(state: VariableRootState): { masterData: VariableCategory[]; masterRowData: VariableCategory } {
    return {
        masterData: state.master.data || [],
        masterRowData: state.slave.data || {} as VariableCategory
    };
}
