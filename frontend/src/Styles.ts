...
Styles.frameStyle = {
    ...
    getCrossDecisionTableIcon: function () {
        return _getStyle("crossDecisionTableIcon", "rf rf-crosstab");
    },
    getCrossDecisionTableIconStyle: function () {
        return _getStyle("crossDecisionTableIconStyle", {color: 'rgb(31, 90, 163)'});
    },
    ...
    getComplexScorecardIcon: function () {
        return _getStyle("complexScorecardIcon", "rf rf-complexscordcard")
    },
    getComplexScorecardIconStyle: function () {
        return _getStyle("complexScorecardIconStyle", {color: "rgb(31, 90, 163)"})
    },
