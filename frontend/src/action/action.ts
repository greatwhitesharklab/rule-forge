...
export function saveData(data: SpringBean[], newVersion: boolean, file: string) {
...
export function deleteParameter(rowIndex: number) {
    return {rowIndex, type: DEL_PARAMETER};
}

export function addSlave(newSlaveData?: ActionMethod) {
    if (newSlaveData) {
...
let currentMasterGridRowIndex: number | null = null;

export function loadSlaveData(masterData: SpringBean, rowIndex: number) {
...
export function loadMethodData(slaveData: ActionMethod) {
