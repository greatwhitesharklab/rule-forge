...
interface ActionEditorProps {
    ...
    slaveRowData: ActionMethod;
    file: string;
    dispatch: (a: unknown) => unknown;
}

class ActionEditor extends Component<ActionEditorProps> {
    masterData: SpringBean | null = null;
    currentData: ActionMethod | null = null;
...
function select(state: ActionRootState): { masterData: SpringBean[]; masterRowData: SpringBean; slaveRowData: ActionMethod } {
    return {
        masterData: state.master.data || [],
        masterRowData: state.slave.data || {} as SpringBean,
        slaveRowData: state.method.data || {} as ActionMethod
    };
}
