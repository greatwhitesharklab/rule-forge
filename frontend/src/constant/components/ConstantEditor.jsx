                    ...
                    <div>
                        <div style={{margin:'2px'}}>
                            ...
                            <div className="btn-group btn-group-sm" style={{margin:'2px'}}>
                                ...
                                <button className="btn btn-danger" type="button" onClick={()=>{dispatch(action.save(true,file))}} style={{display: 'none'}}><i className="rf rf-savenewversion"></i> 保存为新版本</button>
                            </div>
                            <div className="btn-group btn-group-sm" style={{margin:'2px'}}>
