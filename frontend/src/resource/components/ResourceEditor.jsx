...
class ResourceEditor extends Component {
    ...
    render() {
        ...
        const slaveGridHeaders = [
            ...
            {id: 'slave-dsStatus', name: 'dsStatus', label: '状态', filterable: true,editable: false, width: '70px',formatter: (value) => {
                switch(value) {
                    case 0: return '待开发';
                    case 1: return '已上线';
            ...
            <div style={{margin: '0px'}}>
                ...
                <Splitter orientation='vertical' position='450px'>
                    <div style={{padding: '0px'}}>
                        ...
                        <Grid headers={masterGridHeaders} dispatch={dispatch} rows={masterData} rowClick={(rowData) => {
                    ...
                    <div style={{padding: '0px'}}>
                        ...
                        <Grid headers={slaveGridHeaders} dispatch={dispatch} 
                              rows={variables || []} rowClick={(rowData) => {
