...
import {getSimulationProgress} from '../action.js';
...
class SimulationProgress extends Component {
    ...
    renderProgressBar(progress) {
        var totalLogs = progress.totalLogs || 0;
        var totalCompared = progress.totalCompared || 0;
        var pct = totalLogs > 0 ? Math.round(totalCompared / totalLogs * 100) : 0;
        return (
