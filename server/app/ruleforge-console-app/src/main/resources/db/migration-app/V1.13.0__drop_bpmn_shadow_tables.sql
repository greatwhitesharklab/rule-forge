...
--   rfa_decision_flow_log       (V1.2.0 / V1.2.1 / V1.8.1)
...
--
-- 保留:数据源/变量定义(rfa_datasource* / rfa_rule_variable_def)迁到 datasource 模块继续用。

DROP TABLE IF EXISTS `rfa_decision_flow_log`;
