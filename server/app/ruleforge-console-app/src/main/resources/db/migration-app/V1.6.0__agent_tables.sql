...
CREATE TABLE IF NOT EXISTS rfa_agent_config (
...
-- 插入默认配置
INSERT INTO rfa_agent_config (config_key, config_value, description) VALUES
...
-- 聊天会话表
CREATE TABLE IF NOT EXISTS rfa_agent_chat_session (
...
-- 聊天消息表
CREATE TABLE IF NOT EXISTS rfa_agent_chat_message (
    ...
    CONSTRAINT fk_message_session FOREIGN KEY (session_id) REFERENCES rfa_agent_chat_session(id) ON DELETE CASCADE
